...
%% Load data
load('C:\Users\shris\Desktop\CPE 800 Project\Proposition 1\SBR_Data_Matrices.mat');
...
dist_vec = zeros(n,1);
dist_vec(3) = deg2rad(dist_angle_deg);      % phi disturbance
dist_vec(4) = deg2rad(dist_angvel_deg);     % phidot disturbance
...
fprintf('Disturbance angle magnitude = %.2f deg added to phi\n', dist_angle_deg);
fprintf('Disturbance angular velocity = %.2f deg/s added to phidot\n', dist_angvel_deg);
...
save('SBR_DataDriven_Controller_Disturbance_Result.mat', ...
    'K_data', ...
    'Q_val', 'P_val', ...
    'Acl_dd', 'cl_eigs', ...
    'x_test', 'u_test', 'u_cmd_test', ...
    'Ts', ...
    'dist_time', 'dist_angle_deg', 'dist_angvel_deg', ...
    'recovery_time');

disp('================ RESULTS SAVED ===================');
disp('Saved result as SBR_DataDriven_Controller_Disturbance_Result.mat');
